...
def test_serializer_init_response_object_from_dict(
    ...
    """Decorated endpoint should return response_model Object when endpoint returns a valid dict."""
...
def test_serializer_pass_flask_response(
    ...
    """Decorated endpoint should pass a Response Object when endpoint returns one."""
    decorator = serializer(response_model=reponse_model_test_class)
