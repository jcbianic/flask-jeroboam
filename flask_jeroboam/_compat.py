...
Phase 2: ErrorWrapper, MissingError, ErrorList
...
# --- Phase 2: Error wrappers ---
from pydantic.v1.error_wrappers import ErrorWrapper  # noqa: F401
from pydantic.v1.errors import MissingError  # noqa: F401

try:
    from pydantic.v1.error_wrappers import ErrorList  # noqa: F401
except ImportError:  # pragma: no cover
    from typing import Any as ErrorList  # type: ignore[assignment]
